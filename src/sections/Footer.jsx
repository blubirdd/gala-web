    ...
    <footer className="w-full max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
      <div className="text-center">
        ...
        <div className="space-x-1">
          ...
          <a className="github-logo inline-flex justify-center items-center w-10 h-10 text-center text-gray-500 hover:bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800" target='_blank' href="https://github.com/blubirdd">
