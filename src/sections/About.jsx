	...
	return (
		<>
			<div className="about relative pb-6 bg-gray-100 mx-auto z-[0]">
				...
				<h1 className="text-center text-teal-700 text-4xl md:text-5xl font-bold pt-8 drop-shadow-[0_2.2px_2.2px_rgba(0,0,0,0.3)]" data-aos="fade-down" data-aos-delay="500" data-aos-offset="-300">About the island of GALA</h1>
