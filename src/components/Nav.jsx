...
function Nav() {
  return (
  <header className="flex flex-wrap absolute overflow-hidden bg-emerald-700  sm:justify-start sm:flex-nowrap z-50 w-full  text-sm py-4">
  <nav className="max-w-[85rem] w-full mx-auto px-4 sm:flex items-start sm:justify-between" aria-label="Global">
    <div className="flex items-center justify-between">
      <img src="./logo.png" className="w-12 h-7 pr-1" alt="" />
      <a className="flex-none text-base md:text-xl font-semibold text-white" href="#">A Philippine Wildlife Adventure</a>
