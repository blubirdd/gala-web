...
const EnvironmentCard = ({ imgURL, name, description }) => {
    ...
    return (
      <div className="card-border relative sm:h-2 sm:w-100 md:w-64 md:h-[38rem] z-9 pointer-events-none">
        <div
          style={cardStyle}
          className="card bg-cover relative flex items-end rounded-lg w-full h-full text-white cursor-pointer overflow-hidden z-10 pointer-events-auto"
        >
